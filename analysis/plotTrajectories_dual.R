...
setwd('/Users/mayala/Documents/preq data')

# can get these numbers below from dataPrepo.R 
subject_numbers <- c(1:31) 
tasks <- c(0, 3, 10) # this changes for explicit
...
for (tasknum in tasks){
    ...
    plotfilename <- sprintf('paths_preq%d_task%d_lateadaptation.svg', garageno,tasknum)
